...
public class TestExpenseChart extends Application {
	...
	public void start(Stage arg0) throws Exception {
	    	...
	    	Expenses blah3 = (new Expenses("Crickets", 378)); // This tester currently generates a list of expenses and implements it into the controller.
	    	list.addExpense(blah);  // In the final version, this will synchronize with the other classes,
	    	list.addExpense(blah2); // taking an ExpenseList generated by BudgetDisplay and inputting it into the
	    	list.addExpense(blah3); // chart.
